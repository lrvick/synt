...
class TrainerTestCase(unittest.TestCase):
    ...
    def test_train_unsupported_classifier(self):
        self.assertRaises(ValueError, train, 'samples.db', classifier_type='xyz', redis_db=10, purge=True)

class GuesserTestCase(unittest.TestCase):

    def setUp(self):
        train('samples.db', 1000, classifier_type='naivebayes', purge=True, redis_db=10)
